...
CREATE SEQUENCE attendees_attendee_id_seq START WITH 1 INCREMENT BY 1 MINVALUE 1;
CREATE SEQUENCE attendee_tickets_attendee_ticket_id_seq START WITH 1 INCREMENT BY 1 MINVALUE 1;
CREATE SEQUENCE discount_codes_discount_code_id_seq START WITH 1 INCREMENT BY 1 MINVALUE 1;
CREATE SEQUENCE session_schedule_schedule_id_seq START WITH 1 INCREMENT BY 1 MINVALUE 1;
CREATE SEQUENCE sessions_session_id_seq START WITH 1 INCREMENT BY 1 MINVALUE 1;
CREATE SEQUENCE speakers_speaker_id_seq START WITH 1 INCREMENT BY 1 MINVALUE 1;
CREATE SEQUENCE tags_tag_id_seq START WITH 1 INCREMENT BY 1 MINVALUE 1;
CREATE SEQUENCE ticket_prices_ticket_price_id_seq START WITH 1 INCREMENT BY 1 MINVALUE 1;
CREATE SEQUENCE time_slots_time_slot_id_seq START WITH 1 INCREMENT BY 1 MINVALUE 1;
CREATE SEQUENCE workshops_workshop_id_seq START WITH 1 INCREMENT BY 1 MINVALUE 1;
